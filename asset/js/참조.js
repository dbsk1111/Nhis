...
$(function() {
  ...
  $("#cms-print").click(function(k) {
    ...
    var j = $(printSelector);
    if (j.length == 0) {
      if (!confirm("�몄뇙�곸뿭�� 吏��뺣릺吏� �딆븯�듬땲��. �꾩껜�섏씠吏�瑜� �몄뇙 �섏떆寃좎뒿�덇퉴?")) {
        return
      }
    }
    var h = $("html").clone();
...
var youtubeGen = function() {
  $(".jwxe-youtube").each(function() {
    ...
    if (h) {
      var c = (a ? "<center>" : "") + '<iframe title="�좏닾釉� �숈쁺��" align="center" width="' + d + '" height="' + b + '" src="http://www.youtube.com/embed/' + h + '?wmode=transparent" frameborder="0" allowfullscreen';
      c += "></iframe>" + (a ? "</center>" : "");
      f.outerHTML(c)
    }
  })
...
Andwise.app.FrontContentEdit = function() {
  ...
  return {
    ...
    render: function() {
      ...
      b = $('<div class="cms-front-edit" >			<a class="front-edit-cancel" title="�몄쭛痍⑥냼"><i class="fa fa-minus-circle"></i></a>			<a class="front-edit" title="而⑦뀗痢좏렪吏�"><i class="fa fa-edit"/></a>			<a class="front-access" title="�묎렐�깃���"><i class="fa fa-wheelchair"/></a>			<a class="show-hide-toggle"><i class="fa fa-angle-right"/></a>			</div>');
      $("body").append(b);
    ...
    drawEditBox: function() {
      var d = 0;
      b.toggleClass("editing");
      var e = '<div class="cms-edit-wrap"><a class="cms-front-edit front-content-edit" title="�몄쭛"><i class="fa fa-edit"></i></a></div>';
...
Andwise.app.Validator.prototype = {
  regex: {
    ...
    min: {
      hanTail: ["��", "��"],
      msg: function() {
        return String.format($m("pw.minLength", "{0} �� �댁긽 �댁뼱�� �⑸땲��."), this.len)
      },
      len: 0,
      valid: function(b, a) {
        if (!b) {
    ...
    max: {
      hanTail: ["��", "��"],
      msg: function() {
        return String.foramt($m("pw.maxLength", "{0} �� �댄븯留� 媛��ν빀�덈떎."), this.len)
      },
      len: 0,
      valid: function(b, a) {
        if (!b) {
    ...
    a0s: {
      hanTail: ["��", "��"],
      msg: function() {
        return "�곸뼱, �レ옄, �뱀닔臾몄옄媛� 紐⑤몢 �ы븿�섏뼱�� �⑸땲��."
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    aA0s: {
      hanTail: ["��", "��"],
      msg: function() {
        return "�곸뼱 �뚮Ц��, �곸뼱 ��臾몄옄 ,�レ옄, �뱀닔臾몄옄媛� 紐⑤몢 �ы븿�섏뼱�� �⑸땲��."
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    mail: {
      hanTail: ["��", "��"],
      msg: function() {
        return $m("�뺤떇�ㅻ쪟", "�뺤떇�� 留욎� �딆뒿�덈떎.") + " ex) abc@abc.com"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    nospchar: {
      hanTail: ["��", "��"],
      msg: function() {
        return $m("�뺤떇�ㅻ쪟", "�뱀닔 臾몄옄瑜� �ъ슜�� �� �놁뒿�덈떎.") + " ex) a-bc.123_123"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    emaildomain: {
      hanTail: ["��", "��"],
      msg: function() {
        return $m("�뺤떇�ㅻ쪟", "�뺤떇�� 留욎� �딆뒿�덈떎.") + " ex) abc.com"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    saupno: {
      hanTail: ["��", "��"],
      msg: function() {
        return $m("�뺤떇�ㅻ쪟", "�뺤떇�� 留욎� �딆뒿�덈떎.") + " ex) 123-12-12345"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    tel: {
      hanTail: ["", ""],
      msg: function() {
        return $m("�뺤떇�ㅻ쪟", "�뺤떇�� 留욎� �딆뒿�덈떎.") + " ex) 02-123-1234 �먮뒗 010-123-1234"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    mobile: {
      hanTail: ["", ""],
      msg: function() {
        return $m("�뺤떇�ㅻ쪟", "�뺤떇�� 留욎� �딆뒿�덈떎.") + " ex) 010-123-1234"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    zipcode: {
      hanTail: ["", ""],
      msg: function() {
        return $m("�뺤떇�ㅻ쪟", "�뺤떇�� 留욎� �딆뒿�덈떎.") + " ex) 123-123"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    docOnly: {
      hanTail: ["��", "��"],
      msg: function() {
        return "臾몄꽌 �뚯씪留� �낅줈�쒓� 媛��ν빀�덈떎. (docx, doc, pdf, hwp)"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    imgfile: {
      hanTail: ["��", "��"],
      msg: function() {
        return "�대�吏� �뚯씪留� �낅줈�쒓� 媛��ν빀�덈떎. (gif, bmp, png, jpg, jpeg)"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    moviefile: {
      hanTail: ["��", "��"],
      msg: function() {
        return "�숈쁺�� �뚯씪留� �낅줈�쒓� 媛��ν빀�덈떎. (mp4)"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    date: {
      hanTail: ["��", "��"],
      msg: function() {
        return $m("�뺤떇�ㅻ쪟", "�뺤떇�� 留욎� �딆뒿�덈떎.") + " ex) 2013-05-05"
      },
      valid: function(a) {
        if (!a) {
          return true
    ...
    url: {
      hanTail: ["��", "��"],
      msg: function() {
        return $m("�뺤떇�ㅻ쪟", "�뺤떇�� 留욎� �딆뒿�덈떎.") + " ex)http://www.abc.com"
      },
      valid: function(a) {
        if (!a) {
          return true
        ...
        for (var c = 0; c < b.length; c++) {
          ...
          if (h > -1) {
            ...
            if (!this.regex.hasOwnProperty(o)) {
              alert("develop error : �대옒�ㅻ챸 " + m + " �먯꽌 regex key 異붿텧 �ㅻ쪟");
              return false
            }
